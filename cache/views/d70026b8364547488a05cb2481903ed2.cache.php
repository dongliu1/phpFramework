...
<div class="subnav">
	...
	<div class="table-list">
		...
		<tr>
			...
			<th width="50" align="left"><?php echo lang('a-name'); ?></th>
			<th width="50" align="left"><?php echo lang('a-modname'); ?></th>
			...
			<th width="50" align="center"><?php echo lang('a-mem-80'); ?></th>
			<th width="50" align="center"><?php echo lang('a-mem-81'); ?></th>
		...
		<tr height="25">
			...
			<td align="left"><?php echo $mmodels[$t['modelid']]['modelname']; ?></td>
			...
			<?php if ($t['id']>1) { ?>|<a href="javascript:;" onClick="if(confirm('<?php echo lang('a-confirm'); ?>')){ window.location.href='<?php echo $del; ?>'; }"><?php echo lang('a-del'); ?></a><?php } ?>
			</td>
		</tr>
		<?php } } ?>
		<tr height="25">
