...
#loginbar{background:url(views/default/rsc/bg.png);background-size:100% 100%;-moz-background-size:100% 100%;background-repeat:no-repeat; no-repeat 100% 100%;height:100%;width:100%;overflow:hidden;position: absolute;bottom:0%;right:0%;}
#login{    position: absolute;bottom: 150px;right: 100px;color:#333;border-radius: 10px;background: rgba(200,200,200,0.6)}

#login ul{padding:10px 0 0 0;margin:0}
#login ul li{list-style-type:none;padding:10px 0 5px 0;*padding:8px 0 5px 0}
#login ul li span{float:left;text-align:left;padding-top:7px;}
...
.login{float:right;width:265px;height:205px;padding:0 0 0 24px;background-repeat:no-repeat;background-position:0 0}
