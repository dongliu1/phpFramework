...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		...
		<a href="<?php echo url('admin/member/index', array('status'=>3)); ?>" <?php if ($status==3) { ?>class="on"<?php } ?>><em>会员空间关闭</em></a><span>|</span>
		<a href="<?php echo url('admin/member/index', array('status'=>4)); ?>" <?php if ($status==4) { ?>class="on"<?php } ?>><em>会员空间开通</em></a><span>|</span>
		<a href="<?php echo url('admin/member/index', array('status'=>5)); ?>" <?php if ($status==5) { ?>class="on"<?php } ?>><em>会员空间推荐</em></a><span>|</span>
	...
	<div class="table-list">
		...
		<tr>
			...
			<th width="60" align="left"><?php echo lang('a-mem-29'); ?></th>
			<th width="60" align="left"><?php echo lang('a-mem-30'); ?></th>
			<th width="25" align="left"><?php echo lang('a-mem-31'); ?></th>
			<th width="90" align="left"><?php echo lang('a-mem-32'); ?></th>
			<th width="50" align="left"><?php echo lang('a-mod-224'); ?></th>
		...
		<tr height="25">
			...
			<a href="javascript:;" onClick="get_avatar('<?php echo $avatar; ?>')"><?php if ($t['nickname']) {  echo $t['nickname'];  } else {  echo $t['username'];  } ?></a></td>
			...
			<td align="left"><a href="http://www.baidu.com/baidu?wd=<?php echo $t['regip']; ?>" target=_blank title="<?php echo $t['regip']; ?>"><?php echo date(TIME_FORMAT, $t['regdate']); ?></a></td>
			<td align="left"><?php echo $t['spacestatus']; ?></td>
			<td align="left">
