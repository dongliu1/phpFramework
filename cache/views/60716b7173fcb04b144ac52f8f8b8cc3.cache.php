...
<link href="<?php echo ADMIN_THEME; ?>js/jquery-ui.custom.css" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
      <script src="<?php echo ADMIN_THEME; ?>js/html5.js"></script>
    <![endif]-->
...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a href="<?php if ($backurl) {  echo $backurl;  } else {  echo url('admin/content/', array('catid'=>$catid));  } ?>" onclick="clz()"><em><?php echo lang('a-con-42'); ?></em></a><span>|</span>
	...
	<div class="table-list">
		...
		<?php if ($verify) { ?>
		<tr>
			<th width="20%"><?php echo lang('a-mod-137'); ?>：</th>
			<td><a href="<?php echo url('admin/content/editverify', array('id'=>$data['id'])); ?>"><?php echo lang('a-mod-140'); ?></a></td>
		</tr>
		<?php } ?>
		<tr>
			<th width="20%"><font color="red">*</font>&nbsp;<?php echo lang('a-con-29'); ?>：</th>
			<td>
...
$(function(){
	...
	<?php }  } } ?>
	rcms_admin_document = cats[catid];
