...
$(function(){
	...
	//$.getScript("http://www.rox.cn/index.php?c=sys&m=news");
	//$.getScript("http://www.rox.cn/index.php?c=v1&m=version&id=<?php echo CMS_VERSION; ?>");
...
<div class="col-2 col-auto">
	...
	※ <?php echo lang('a-ind-7'); ?><br />
	※ <?php echo lang('a-ind-8'); ?><br />
	※ <?php echo lang('a-ind-9'); ?><br />
	</p>
	<div class="bk20 hr"><hr></div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
    <td colspan="2"><?php echo lang('a-ind-10'); ?>：&nbsp;<?php echo CMS_NAME; ?>&nbsp;<?php echo CMS_VERSION; ?> <span id="rcms_version"></span></td>
    </tr>
    <tr>
    <td colspan="2"><?php echo lang('a-ind-11'); ?>：&nbsp;<?php echo PHP_OS; ?> 、 PHP<?php echo PHP_VERSION; ?> 、 Mysql<?php echo $sqlversion; ?> 、 <?php echo strcut($_SERVER['SERVER_SOFTWARE'], 20); ?></td>
    </tr>
	</table>
	</div>
</div>
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
	    <table width="540" border="0" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="261"><?php echo lang('a-ind-17'); ?>：&nbsp;<a href="<?php echo url('admin/member/'); ?>"><span id="member_1"><img src="<?php echo ADMIN_THEME; ?>images/onLoad.gif"></span></a></td>
			<td width="279"><?php echo lang('a-ind-18'); ?>：&nbsp;<a href="<?php echo url('admin/member/', array('status'=>2)); ?>"><span id="member_2"><img src="<?php echo ADMIN_THEME; ?>images/onLoad.gif"></span></a></td>
		  </tr>
		</table>
	    <div class="bk20 hr"><hr></div>
		<table width="540" border="0" cellpadding="0" cellspacing="0">
		<?php if (is_array($category)) { $count=count($category);foreach ($category as $t) {  if ($t['ismenu']==1) { ?>
		  <tr>
			<td width="261"><?php echo $t['catname']; ?>：&nbsp;<a href="<?php echo url('admin/content/', array('modelid'=>$t['modelid'],'catid'=>$t['catid'])); ?>"><span id="m_<?php echo $t['modelid']; ?>_1"><img src="<?php echo ADMIN_THEME; ?>images/onLoad.gif"></span></a></td>
			<td width="279"><?php echo lang('a-ind-18'); ?>：&nbsp;<a href="<?php echo url('admin/content/verify', array('modelid'=>$t['modelid'], 'status'=>3)); ?>"><span id="m_<?php echo $t['modelid']; ?>_2"><img src="<?php echo ADMIN_THEME; ?>images/onLoad.gif"></span></a></td>
		  </tr>
		  <script type="text/javascript">
			$(function(){
...
<!--<div class="col-2 col-auto">
	...
	<div class="content" id="rcms_news">
