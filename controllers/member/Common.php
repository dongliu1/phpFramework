...
class Member extends Common {
	...
	public function __construct() {
		...
		if ($this->memberinfo) {
			...
			define('MEMBER_THEME',	SITE_PATH . basename(VIEW_DIR) . DIRECTORY_SEPARATOR .MEMBER_PATH. DIRECTORY_SEPARATOR);
			define('MEMBER_DIR',	VIEW_DIR . DIRECTORY_SEPARATOR .MEMBER_PATH. DIRECTORY_SEPARATOR);
		}
	}
