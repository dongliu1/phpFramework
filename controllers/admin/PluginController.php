...
class PluginController extends Admin {
	...
	public function ajaxupdateAction() {
		...
		$version = fn_geturl('http://app.rcms.net/index.php?c=my&a=version&markid=' . $data['markid']);
	...
	public function onlineAction() {
		...
		$this->view->assign('url', 'http://app.rcms.net/?v=3&admin=' . ADMIN_NAMESPACE . '&site=' . $site . '&name=' . $name . '&data=' . $data . '&version=' . CMS_VERSION);
	    $this->view->display('plugin_online');
	}
	...
	public function downAction() {
		...
		if ($result = fn_check_url()) {
		    $this->adminMsg($result . '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://bbs.rcms.net/forum.php?mod=viewthread&tid=100&extra=" target="_blank" style="font-size:14px">' . lang('a-plu-24') . '</a>');exit;
		}
