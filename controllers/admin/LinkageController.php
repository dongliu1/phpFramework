...
class LinkageController extends Admin {
	...
	public function listAction() {
		...
		$this->view->display('linkage_list');
    }
	...
	public function addsonAction() {
		...
		$this->view->display('' . (is_file(VIEW_DIR . ADMIN_PATH . DIRECTORY_SEPARATOR ."linkage_addson_".$keyid.".html") ? 'linkage_addson_'.$keyid : 'linkage_addson'));
	   // $this->view->display('linkage_addson');
	}
