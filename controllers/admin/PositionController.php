...
class PositionController extends Admin {
	...
	public function indexAction() {
	    ...
	    $this->view->display('position_list');
	}
	...
	public function addAction() {
	    ...
	    $this->view->display('position_add');
	}
	...
	public function listAction() {
	    ...
	    $this->view->display('position_data_list');
	}
	...
	public function adddataAction() {
	    ...
	    $this->view->display('position_data_add');
	}
	...
	public function ajaxloadinfoAction() {
	    ...
	    $this->view->display('position_data_load');
	}
}