...
class TagController extends Admin {
	...
	public function importAction() {
	    ...
	    $this->view->display('tag_import');
	}
	
	public function cacheAction($show=0) {
	    $qok  = $this->get('qok');
		if ($show == 0 && !$qok) $this->adminMsg(lang('a-tag-20'), url('admin/tag/cache', array('qok'=>1)), 0, 1, 2);
