...
class SiteController extends Admin {
	...
	public function delAction($id = 0, $show = 0) {
		...
		//删除assets
		$this->content->set_table_name('assets');
		$this->content->delete('keyid<>0 AND site=' . $site);
		//删除网站配置文件
	...
	public function configAction() {
        ...
        if ($this->post('submit')) {
            $data = $this->post('data');
            $body = "<?php" . PHP_EOL . "if (!defined('IN_RCMS')) exit();" . PHP_EOL . PHP_EOL . "/**" . PHP_EOL . " * " . $data['SITE_NAME'] . "配置" . PHP_EOL . " */" . PHP_EOL . "return array(" . PHP_EOL . PHP_EOL;
	...
	private function set_site_url($data) {
	    $body = "<?php" . PHP_EOL . "if (!defined('IN_RCMS')) exit();" . PHP_EOL . PHP_EOL . "/**" . PHP_EOL . " * 多站点域名配置文件" . PHP_EOL . " */" . PHP_EOL . "return array(" . PHP_EOL . PHP_EOL;
