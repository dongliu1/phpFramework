...
class InstallController extends Controller {
	...
	public function indexAction() {
		...
		switch($step) {
			...
			case '5'://安装进度
				...
				//保存配置文件
				$content  = "<?php" . PHP_EOL . "if (!defined('IN_RCMS')) exit();" . PHP_EOL . PHP_EOL . "/**" . PHP_EOL . " * 数据库配置信息" . PHP_EOL . " */" . PHP_EOL . "return array(" . PHP_EOL . PHP_EOL;
                ...
                //保存站点域名配置文件
                $site  = "<?php" . PHP_EOL . "if (!defined('IN_RCMS')) exit();" . PHP_EOL . PHP_EOL . "/**" . PHP_EOL . " * 数据库配置信息" . PHP_EOL . " */" . PHP_EOL . "return array(" . PHP_EOL . PHP_EOL;
	...
	private function installsql($sql) {
		$sql  = str_replace(array(PHP_EOL, chr(13), chr(10)), 'SQL_RCMS_EOL', $sql);
		$ret  = array(); 
		$num  = 0;
		$data = explode(';SQL_RCMS_EOL', trim($sql));
		foreach($data as $query){
			$queries = explode('SQL_RCMS_EOL', trim($query)); 
