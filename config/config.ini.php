...
return array(
	...
	'ADMIN_NAMESPACE'         => 'skadmin',  //后台管理路径名字，默认admin
	'SYS_DOMAIN'              => '',  //域名目录，针对虚拟主机用户
	'SYS_DEBUG'               => true,  //调试模式开关，网站正式上线时建议关闭
	'SYS_LOG'                 => true,  //程序运行日志开关,日志目录（项目目录/cache/logs/）
	'SYS_VAR_PREX'            => 'rcms_d1538_',  //Sessoin、Cookie变量前缀
	'SYS_GZIP'                => false,  //是否Gzip压缩后输出
	'SITE_MEMBER_COOKIE'      => 'f9feff139af6d74',  //Cookie随机字符串
	'SESSION_COOKIE_DOMAIN'   => '',  //多站点用户登录状态跨域保存域名，格式如.rcms.net（只针对多站点域名全是二级域名否则请留空）
	...
	'SITE_ADMIN_PAGESIZE'     => '20',  //后台数据分页条数
	'SITE_SYSMAIL'            => '',  //用来接收网站的一些系统邮件
	'SITE_MAIL_TYPE'          => '1',  //邮件发送模式
	'SITE_MAIL_SERVER'        => 'smtp.qq.com',  //邮件服务器
	'SITE_MAIL_PORT'          => '25',  //邮件端口号
	'SITE_MAIL_FROM'          => 'bernardrao@qq.com',  //发送人地址
	'SITE_MAIL_AUTH'          => '1',  //是否AUTH LOGIN验证
	'SITE_MAIL_USER'          => 'bernardrao',  //验证用户名
	'SITE_MAIL_PASSWORD'      => 'liulingliuling',  //验证密码
