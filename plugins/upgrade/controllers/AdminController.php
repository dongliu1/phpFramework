...
class AdminController extends Plugin {
    ...
    public function __construct() {
		...
		$this->file_url = 'http://www.rox.cn/v1/';
		$this->data_url = 'http://www.rox.cn/index.php?c=v1&m=verlist';
		if ($result = fn_check_url()) {
		    $this->adminMsg($result . '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://bbs.rcms.net/forum.php?mod=viewthread&tid=100&extra=" target="_blank" style="font-size:14px">单击查看开启方式</a>');exit;
		}
    }
	...
	private function dir_mode_info() {
        if (strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {
            /* 测试文件 */
            $test_file = APP_ROOT . 'rcms_test.txt';
			/* 检查目录是否可读 */
