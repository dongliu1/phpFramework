...
class UserModel extends Model {
	...
	public function get_role_list() {
	    //return $this->from('role')->where("roleid>1")->order('roleid ASC')->select();//rox修改，添加roleid>1
		return $this->from('role')->order('roleid ASC')->select();//rox修改，添加roleid>1
	}
	...
	public function get_user_list($roleid=NULL, $admin=0) {
		...
		//$model->where('userid>1');//rox修改 添加userid>1
